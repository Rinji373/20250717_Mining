...
for(i in 1:nrow(polygon)){
  ...
  #### 雲マスク前の画像から中央値合成画像
  composite_unmasked <- LC08$select(c('B1','B2','B3','B4','B5','B6','B7','B8','B8A','B9','B11','B12'))$max()
  ...
  # 各画像の年間最小値合成画像を作成
  composite_1 <- LC08_masked_1$select(c('B1','B2','B3','B4','B5','B6','B7','B8','B8A','B9','B11','B12'))$max()
  composite_2 <- LC08_masked_2$select(c('B1','B2','B3','B4','B5','B6','B7','B8','B8A','B9','B11','B12'))$max()
  composite_3 <- LC08_masked_3$select(c('B1','B2','B3','B4','B5','B6','B7','B8','B8A','B9','B11','B12'))$max()
  composite_4 <- LC08_masked_4$select(c('B1','B2','B3','B4','B5','B6','B7','B8','B8A','B9','B11','B12'))$max()
  composite_5 <- LC08_masked_5$select(c('B1','B2','B3','B4','B5','B6','B7','B8','B8A','B9','B11','B12'))$max()
  ...
  task_combined <- ee_image_to_drive(
    ...
    timePrefix = FALSE,
    folder = "Sentinel-2_Yearly_MaxComposite",
    region = region,
    scale = 10
  )
  task_combined$start()
